...
# query = "Drop table incharge"

# query = "Create Table documents_received_tobuyer_bysupplier(PONumber VARCHAR(10), BOL BOOLEAN, PFI BOOLEAN, Drawings Boolean, MQIC BOOLEAN)"
# query = "Create Table documents_received_tosupplier_bybuyer(PONumber VARCHAR(10), LOC BOOLEAN)"

# query = "Create table incharge(PONumber VARCHAR(10), BOL VARCHAR(255), PFI VARCHAR(255), Drawings VARCHAR(255), MQIC VARCHAR(255), LOC VARCHAR(255)) "


# cur.execute("Select * from purchase_orders;")

query = "Alter Table buyer_received_docs Rename documents_received_toBuyer_bySupplier"
query = " Alter Table supplier_received_docs Rename documents_received_tosupplier_byBuyer;"

query = "Alter Table documents_received_toBuyer_bySupplier RENAME documents_received_tobuyer_bysupplier"
cur.execute(query)
query = "Alter Table documents_received_tosupplier_byBuyer RENAME documents_received_tosupplier_bybuyer"
cur.execute(query)
